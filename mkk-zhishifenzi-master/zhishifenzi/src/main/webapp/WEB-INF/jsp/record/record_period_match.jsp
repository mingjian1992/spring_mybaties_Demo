...
<html>
<head>
    <title>${listDto.name}的比赛记录</title>
</head>
<body>
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-warning">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-8">
                        <strong>${listDto.name}的比赛记录</strong>

                        <form class="form-inline" role="form" action="" id="mForm">
                            <input type="hidden" name="start" value="${listDto.start}"/>
                            <input type="hidden" name="end" value="${listDto.end}"/>
