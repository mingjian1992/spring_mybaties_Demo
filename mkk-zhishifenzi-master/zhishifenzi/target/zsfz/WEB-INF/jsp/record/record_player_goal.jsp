...
<html>
<head>
    <title>${listDto.name}的进球纪录</title>
</head>
<body>
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-warning">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-8">
                        <strong>${listDto.name}的进球纪录</strong>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    ...
                    <dis:table id="n" class="table table-striped table-hover" list="${listDto}"
                        ...
                        <dis:column title="进球数">
                            <span class="label label-default">${n.amount}</span>
                            <c:set var="totalScores" value="${totalScores + n.amount}"/>
                        </dis:column>
                        <dis:column title="球场">
                        ...
                        <dis:footer>
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td><span class="label label-success">${totalScores}</span></td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                        </dis:footer>
