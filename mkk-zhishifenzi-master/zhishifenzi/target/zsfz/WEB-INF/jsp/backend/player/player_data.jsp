...
<html>
<head>
    <c:set var="name" value="${dataDto.playerDto.fullName}"/>
    <title>${name}的数据</title>
    <style>
        .data-content {
            padding-top: 40px;
            color: #222222;
...
<div class="row">
    <div class="col-md-12">
        <div class="alert alert-success">
            <div><i class="glyphicon glyphicon-stats"></i>
                ${name}的数据, 场上位置: ${dataDto.playerDto.position.label}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="data-content">
                                ...
                                <p class="text-info">
                                    截止今日(${dataDto.today}), ${name}已经打进了${dataDto.myScores}个进球,
                    ...
                    <div class="row">
                        <div class="col-md-5 col-md-offset-2">
                            <div class="data-content pull-right">
                                ...
                                <p class="text-info">
                                    时至今日(${dataDto.today}), ${name}已完成了${dataDto.myAssists}次助攻,
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="data-content">
                                ...
                                <p class="text-info">
                                    从古至今, ${name}参与了球队一共${dataDto.totalMatches}场正式比赛中的${dataDto.myMatches}场, 参赛率为<strong
                    ...
                    <div class="row">
                        <div class="col-md-5 col-md-offset-2">
                            <div class="data-content pull-right">
                                ...
                                <p class="text-info">
                                    回忆过去, ${name}参与的比赛已经取得了${dataDto.win}次胜利, 外加${dataDto.equals}次平局与${dataDto.fail}次失利,
                                    获胜率为<strong
